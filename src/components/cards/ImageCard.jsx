  ...
  return (
    <div>
      ...
      >
        ...
        >
          <FaPlay size="26px" className="ml-1 cursor-pointer text-white" />
        </span>

        {checkInLocalData(id, `${type}s`) ? (
          <FaHeart
            size="26px"
            className="absolute bottom-2 left-4 text-red-500 hover:scale-125 duration-300 storage cursor-pointer"
            onClick={() => {
          ...
          <FaRegHeart
            size="24px"
            className="absolute bottom-2 left-4 text-white  hover:scale-125 duration-300 storage cursor-pointer"
            onClick={() => {
